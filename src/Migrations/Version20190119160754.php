 ...
 */
final class Version20190119160754 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD author_id INT NOT NULL, ADD slug VARCHAR(255) DEFAULT NULL, DROP author');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD author VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP author_id, DROP slug');
    }
}
